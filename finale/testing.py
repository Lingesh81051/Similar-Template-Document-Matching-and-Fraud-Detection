...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\likith\Music\finale\assets\frame0")#<------------ change the path
...
def read_company_users_from_csv(filename):
    with open(filename, 'r') as file:
        ...
        company_users = [row[0] for row in reader]  
...
class ImageComparator:
    def __init__(self, master, canvas):
        ...
        self.label_status = Label(master, text="", font=("Inter", 12)) # font size to 12
        self.label_status.pack()
...
# text area
        self.text_area = Text(master, height=5, width=32 ,font=("Inter", 18),fg="blue")
...
#<----------------------buttons------------------------------------------------>
    ...
    def write_company_users_to_csv(file_path, data):
        with open(file_path, 'w', newline='') as csvfile:
            fieldnames = [ 'name', 'AGE']  # Define the column names
    ...
    company_users_data = [
        { 'name': 'chris', 'AGE': '55'},
        { 'name': 'likith Kumar S', 'AGE': '21'},
        { 'name': 'Abigatl ZwHin', 'AGE': '25'},
    ]
...
# Write company user data to the CSV file
    ...
    def display_claimed_document(self, filename):
        ...
        image.thumbnail((100, 200))  # Resize the image to fit in the frame
    ...
    # Update status label with results
        self.label_status.config( bg="blue",text=f"{genuine_count}-Documents found genuine.\n {fraud_count}-Documents found fraudulent.")
        self.label_status.config(font=("Inter",20))
    ...
    def open_company_window(self):
        ...
        company_window.geometry("1050x550")
